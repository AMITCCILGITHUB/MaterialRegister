...
public class ValidationMasterId implements Serializable, Comparable<ValidationMasterId> {
    ...
    public int compareTo( ValidationMasterId o ) {
        if ( this.validationType.get().compareTo( o.getValidationType() ) == 0 ) {
            return validationCode.getValue().compareTo( o.validationCodeProperty().getValue() );
        }
        else {
