...
public class HeatChartMaster implements Serializable {
    ...
    public HeatChartMaster(String chartNumber, String equipment, String customer, String poDetails, String drawingNumber, String surveyor, String status, String createdBy, Date createdDate) {
    ...
    public HeatChartMaster(String chartNumber, String equipment, String customer, String poDetails, String drawingNumber, String surveyor, String status, String createdBy, Date createdDate, Set<HeatChartSheets> heatchartsheets) {
        this.chartNumber = new SimpleStringProperty(chartNumber);
        this.equipment = new SimpleStringProperty(equipment);
        this.customer = new SimpleStringProperty(customer);
        this.poDetails = new SimpleStringProperty(poDetails);
