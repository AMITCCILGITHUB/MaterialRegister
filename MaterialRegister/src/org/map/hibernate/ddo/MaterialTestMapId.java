...
public class MaterialTestMapId implements Serializable,
		Comparable<MaterialTestMapId> {
	...
	public String toString() {
		...
		return "MaterialTestMapId{" + "ctNumber=" + ctNumber + ", testCode="
				+ testCode + '}';
	}
