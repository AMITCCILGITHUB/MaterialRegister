...
public class HeatChartSheets implements Serializable, Comparable<HeatChartSheets> {
    ...
    public HeatChartSheets( HeatChartSheetsId id, MaterialMaster materialmaster, HeatChartMaster heatchartmaster, int sequenceNumber, String partNumber, String partName, String speciedSize, String speciedGrade, String status, String createdBy, Date createdDate ) {
        this.id = id;
    ...
    public void resetHeatChartSheets( HeatChartSheets hSheets ) {
        ...
        this.sequenceNumber = new SimpleIntegerProperty( hSheets.getSequenceNumber() );
    ...
    public int compareTo( HeatChartSheets o ) {
        if ( o instanceof HeatChartSheets && o != null ) {
            if ( this.id.equals( o.getId() ) ) {
                return sequenceNumber.getValue().compareTo( o.sequenceNumberProperty().getValue() );
            }
            else {
