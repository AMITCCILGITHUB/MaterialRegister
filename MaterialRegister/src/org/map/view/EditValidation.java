...
import org.map.controls.combobox.ResultComboBox;
import org.map.controls.combobox.SpecificationComboBox;
import org.map.controls.combobox.TestComboBox;
...
public class EditValidation extends TabPane {
	...
	public void createAgencyTab() {
		...
		final AgencyComboBox agencyNameBox = new AgencyComboBox("Agency Name",
				agency);
	...
	public void createCustomerTab() {
		...
		final CustomerComboBox customerNameBox = new CustomerComboBox(
				...
				if (customerNameBox.getText().trim().length() > 0) {
					...
					PersistValidationDetails pvd = ServiceManager
							.getValidationDetailsService("Customer",
									customer.get(), PersistType.UPDATE);
	...
	public void createItemTab() {
		...
		final ItemComboBox itemNameBox = new ItemComboBox("Item Name", item);
	...
	public void createLaboratoryTab() {
		...
		final LaboratoryComboBox laboratoryNameBox = new LaboratoryComboBox(
				...
				if (laboratoryNameBox.getText().trim().length() > 0) {
					...
					PersistValidationDetails pvd = ServiceManager
							.getValidationDetailsService("Laboratory",
									laboratory.get(), PersistType.UPDATE);
	...
	public void createResultTab() {
		...
		final ResultComboBox resultNameBox = new ResultComboBox("Result Name",
				result);
	...
	public void createSpecificationTab() {
		...
		final SpecificationComboBox specificationNameBox = new SpecificationComboBox(
				...
				if (specificationNameBox.getText().trim().length() > 0) {
					...
					PersistValidationDetails pvd = ServiceManager
							.getValidationDetailsService("Specification",
									specification.get(), PersistType.UPDATE);
	...
	public void createTestTab() {
		...
		final TestComboBox testNameBox = new TestComboBox("Test Name", test);
