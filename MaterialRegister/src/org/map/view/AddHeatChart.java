...
public class AddHeatChart {
    ...
    public Node createView() {
        try {
            ...
            Label detailCategoryHeader = new Label("Details - " + heatChart.getChartNumber());
            ...
            addSheetButton.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent e) {
                    ...
                    hs.getId().setChartNumber(heatChart.getChartNumber());
                    hs.getId().setSheetNumber(data.get(data.size() - 1).getId().getSheetNumber() + 1);
                    data.add(hs);
                }
            });
            ...
            addRecordButton.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent e) {
                    ...
                    hs.setSequenceNumber(data.size() + 1);
                    hs.getId().setChartNumber(heatChart.getChartNumber());
                    hs.getId().setSheetNumber(data.get(data.size() - 1).getId().getSheetNumber());
                    data.add(hs);
                }
            });
            ...
            buttons.getChildren().addAll(addSheetButton, addRecordButton, saveRecordButton, printButton);
