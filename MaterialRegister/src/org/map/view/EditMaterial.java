...
public class EditMaterial {
    ...
    public Node createView() {
        try {
            ...
            final EComboBox agencyTextField = new EComboBox( "", "Inspection Agency", "Agency", material.inspectionAgencyProperty(), true );
            Label specLabel = new Label( "Specification" );
            specLabel.setPrefWidth( LABEL_WIDTH );
            final EComboBox specTextField = new EComboBox( "", "Specification", "Specification", material.specificationProperty(), true );
            ...
            final EComboBox itemTextField = new EComboBox( "", "Item Name", "Item", material.itemProperty(), true );
            Label sizeLabel = new Label( "Size" );
            sizeLabel.setPrefWidth( LABEL_WIDTH );
            final EditableBox sizeTextField = new EditableBox( "", "Size", material.sizeProperty(), true );
            Label quantityLabel = new Label( "Quantity" );
            quantityLabel.setPrefWidth( LABEL_WIDTH );
            final ViewIntegerBox quantityTextField = new ViewIntegerBox( 1, material.quantityProperty(), true );
            Label heatNumberLabel = new Label( "Heat / Lot Number" );
            heatNumberLabel.setPrefWidth( LABEL_WIDTH );
            final EditableBox heatNumberTextField = new EditableBox( "", "Heat / Lot Number", material.heatNumberProperty(), true );
            Label plateNumberLabel = new Label( "Plate / Product Number" );
            plateNumberLabel.setPrefWidth( LABEL_WIDTH );
            final EditableBox plateNumberTextField = new EditableBox( "", "Plate / Product Number", material.plateNumberProperty(), true );
            ...
            etg = new EditTestGroup( material.getCtNumber(), material.getTests().iterator() );
            ...
            final EComboBox custTextField = new EComboBox( "", "Customer Name", "Customer", material.customerProperty(), true );
            Label equipLabel = new Label( "Equipments" );
            equipLabel.setPrefWidth( LABEL_WIDTH );
            final EditableBox equipTextField = new EditableBox( "", "Equipments", material.equipmentsProperty(), true );
            Label labLabel = new Label( "Laboratory" );
            labLabel.setPrefWidth( LABEL_WIDTH );
            final EComboBox labTextField = new EComboBox( "", "Laboratory", "Laboratory", material.laboratoryProperty(), true );
            Label repDateLabel = new Label( "Report Date" );
            repDateLabel.setPrefWidth( LABEL_WIDTH );
            final EditableBox repDateCalendarBox = new EditableBox( "", "dd-MM-yyyy", material.reportDateProperty(), true );
            Label repNumberLabel = new Label( "Report Number" );
            repNumberLabel.setPrefWidth( LABEL_WIDTH );
            final EditableBox repNumberTextField = new EditableBox( "", "Report Number", material.reportNumberProperty(), true );
            Label remarksLabel = new Label( "Remarks" );
            remarksLabel.setPrefWidth( LABEL_WIDTH );
            final EComboBox remarksTextField = new EComboBox( "", "Remarks", "Remarks", material.remarksProperty(), true );
            Label resulLabel = new Label( "Result" );
            resulLabel.setPrefWidth( LABEL_WIDTH );
            final EditableBox resultTextField = new EditableBox( "", "Result", material.resultProperty(), true );
            Label witnessedByLabel = new Label( "Witnessed By" );
            witnessedByLabel.setPrefWidth( LABEL_WIDTH );
            final EditableBox witnessedByTextField = new EditableBox( "", "Witnessed By", material.witnessedByProperty(), true );
            ...
            updateButton.setOnAction( new EventHandler<ActionEvent>() {
                ...
                public void handle( ActionEvent e ) {
                    if ( resultTextField.getText().equalsIgnoreCase( "Rejected" ) && reasonOfFailure.getText().trim().length() == 0 ) {
                        ...
                        MaterialData.updateMaterialTestMap( material, etg.getNewTestList().iterator() );
                    }
                }
            } );
            ...
            tableMailbox.getSelectionModel().selectedItemProperty().addListener( new ChangeListener() {
                ...
                public void changed( ObservableValue observable, Object oldValue, Object newValue ) {
                    ...
                    if ( selectedValue != null ) {
                        ...
                        etg = new EditTestGroup( material2.getCtNumber(), material2.getTests().iterator() );
            ...
            EventHandler undoEventHandler = new EventHandler<ActionEvent>() {
                ...
                public void handle( ActionEvent actionEvent ) {
                    final MaterialMaster delMaterial = tableMailbox.getSelectionModel().getSelectedItem();
                    ...
                    Confirm.showConfirm( MaterialRegister.getMaterialRegister().getPrimaryStage(), "Confirm", "Confirm", "Restore " + delMaterial.getCtNumber() + ". Are you sure?", delUserEvent );
                }
            };
            ...
            EventHandler deleteEventHandler = new EventHandler<ActionEvent>() {
                ...
                public void handle( ActionEvent actionEvent ) {
                    ...
                    Confirm.showConfirm( MaterialRegister.getMaterialRegister().getPrimaryStage(), "Confirm", "Confirm", "Delete " + delMaterial.getCtNumber() + ". Are you sure?", delUserEvent );
                }
            };
