...
public class ViewReport {
    ...
    private ObservableList<MaterialMaster> data = FXCollections.observableArrayList( MaterialData.getMaterialList() );
    ...
    public Node createView() {
        ...
        try {
            ...
            Col1.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "ctNumber" ) );
            TableColumn Col2 = new TableColumn( "Inspection Agency" );
            Col2.setPrefWidth( COLUMN_WIDTH_MAX );
            Col2.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "inspectionAgency" ) );
            TableColumn Col3 = new TableColumn( "Description" );
            TableColumn Col31 = new TableColumn( "Item" );
            Col31.setPrefWidth( COLUMN_WIDTH );
            Col31.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "item" ) );
            TableColumn Col32 = new TableColumn( "Size" );
            Col32.setPrefWidth( COLUMN_WIDTH );
            Col32.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "size" ) );
            TableColumn Col33 = new TableColumn( "Quantity" );
            Col33.setPrefWidth( COLUMN_WIDTH );
            Col33.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "quantity" ) );
            TableColumn Col34 = new TableColumn( "Heat / Lot Number" );
            Col34.setPrefWidth( COLUMN_WIDTH_MAX );
            Col34.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "heatNumber" ) );
            TableColumn Col35 = new TableColumn( "Plate / Product Number" );
            Col35.setPrefWidth( COLUMN_WIDTH_MAX );
            Col35.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "plateNumber" ) );
            ...
            Col4.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "specification" ) );
            TableColumn Col5 = new TableColumn( "Tests" );
            Col5.setPrefWidth( COLUMN_WIDTH );
            Col5.setCellValueFactory( new PropertyValueFactory<MaterialMaster, MaterialTestMap>( "tests" ) );
            TableColumn Col6 = new TableColumn( "Customer" );
            Col6.setPrefWidth( COLUMN_WIDTH );
            Col6.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "customer" ) );
            TableColumn Col7 = new TableColumn( "Equipments" );
            Col7.setPrefWidth( COLUMN_WIDTH );
            Col7.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "equipments" ) );
            TableColumn Col8 = new TableColumn( "Laboratory" );
            Col8.setPrefWidth( COLUMN_WIDTH );
            Col8.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "laboratory" ) );
            TableColumn Col9 = new TableColumn( "Report" );
            TableColumn Col91 = new TableColumn( "Number" );
            Col91.setPrefWidth( COLUMN_WIDTH );
            Col91.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "reportNumber" ) );
            TableColumn Col92 = new TableColumn( "Date" );
            Col92.setPrefWidth( COLUMN_WIDTH );
            Col92.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "reportDate" ) );
            Col9.getColumns().addAll( Col91, Col92 );
            TableColumn Col10 = new TableColumn( "Remarks" );
            Col10.setPrefWidth( COLUMN_WIDTH );
            Col10.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "remarks" ) );
            TableColumn Col11 = new TableColumn( "Witnessed By" );
            Col11.setPrefWidth( COLUMN_WIDTH );
            Col11.setCellValueFactory( new PropertyValueFactory<MaterialMaster, String>( "witnessedBy" ) );
            ...
            searchRecordButton1.setOnAction( new EventHandler<ActionEvent>() {
                ...
                public void handle( ActionEvent e ) {
                    try {
                        List<MaterialMaster> materials = MaterialData.searchMaterialDetailsCt( ctNumberFromTextField.getText(), ctNumberToTextField.getText(), true );
            ...
            searchRecordButton2.setOnAction( new EventHandler<ActionEvent>() {
                ...
                public void handle( ActionEvent e ) {
                    try {
                        List<MaterialMaster> materials = MaterialData.searchMaterialDetailsDt( fromDateTextField.getSelectedDate(), toDateTextField.getSelectedDate(), true );
                        data.setAll( materials );
                    }
                    catch ( Exception ex ) {
                        Alert.showAlert( MaterialRegister.getMaterialRegister().getPrimaryStage(), "Error", "Error", "Some error occured. Details...\n" + ex.getMessage() );
            ...
            table.setContextMenu( new TableContextMenu( printEventHandler, "Print" ) );
            ...
            pmr.stateProperty().addListener( new ChangeListener<Worker.State>() {
                ...
                public void changed( ObservableValue<? extends Worker.State> observable, Worker.State oldValue, Worker.State newState ) {
                    if ( newState == Worker.State.SUCCEEDED ) {
                        ...
                        Alert.showAlert( MaterialRegister.getMaterialRegister().getPrimaryStage(), "Alert", "Alert", "The report has been saved as " + pmr.getValue() );
