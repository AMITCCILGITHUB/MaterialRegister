...
public class AboutUs {
    ...
    public void initComponents(final Stage parentStage) {
        ...
        this.scene.getStylesheets().add(MaterialRegister.class.getResource("/org/map/style/about.css").toExternalForm());
        ...
        leftContent.getChildren().addAll(aboutTitle, company, address1, address2, telephone, email, website, submitBtn);

        VBox rightContent = new VBox();
        rightContent.setPrefSize(515, 410);
        rightContent.getStyleClass().add("map-content");

        final URL urlGoogleMaps = MaterialRegister.class.getResource("/org/map/googlemap/googlemapframe.html");
