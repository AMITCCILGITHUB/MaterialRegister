...
public class MessagePopUp {
    ...
    public MessagePopUp( final Stage parentStage, String title, String type, String message ) {
        ...
        this.scene.getStylesheets().add( MaterialRegister.class.getResource( "/org/map/style/popup.css" ).toExternalForm() );
        ...
        if ( type.equalsIgnoreCase( "Error" ) ) {
            icon = ImageViewBuilder.create().image( new Image( MaterialRegister.class.getResourceAsStream( "/org/map/images/error.png" ) ) ).build();
        }
        else if ( type.equalsIgnoreCase( "Info" ) ) {
            icon = ImageViewBuilder.create().image( new Image( MaterialRegister.class.getResourceAsStream( "/org/map/images/info.png" ) ) ).build();
        }
        else if ( type.equalsIgnoreCase( "Confirm" ) ) {
            icon = ImageViewBuilder.create().image( new Image( MaterialRegister.class.getResourceAsStream( "/org/map/images/confirm.png" ) ) ).build();
        }
        else {
            icon = ImageViewBuilder.create().image( new Image( MaterialRegister.class.getResourceAsStream( "/org/map/images/info.png" ) ) ).build();
        ...
        parentStage.xProperty().addListener( new ChangeListener() {
        ...
        parentStage.yProperty().addListener( new ChangeListener() {
