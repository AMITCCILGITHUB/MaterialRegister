...
public class StatusBar {
    ...
    public void initComponents(final Stage parentStage, String message) {
        ...
        this.scene.getStylesheets().add(MaterialRegister.class.getResource("/org/map/style/statusbar.css").toExternalForm());
        ...
        parentStage.heightProperty().addListener(new ChangeListener() {
        ...
        parentStage.widthProperty().addListener(new ChangeListener() {
