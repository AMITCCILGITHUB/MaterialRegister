...
public class TETSCheckBox extends Region {
    ...
    public TETSCheckBox( String textValue, String promptText, StringProperty propertyName, boolean bidirectional ) {
        initComponent( textValue, promptText );
        if ( bidirectional ) {
    ...
    public TETSCheckBox( String textValue, String promptText, StringProperty propertyName, boolean bidirectional, final SimpleIntegerProperty value, boolean bidirectionnal ) {
        initComponent( textValue, promptText );
        if ( bidirectional ) {
            textBox.bindBidirectional( propertyName );
        }
    ...
    private void initComponent( String textValue, String promptText ) {
        ...
        checkBox = CheckBoxBuilder.create().allowIndeterminate( true ).selected( true ).disable( true ).prefHeight( Layout.getCheckBoxHeight() ).prefWidth( Layout.getCheckBoxWidth() ).text( selectedTextValue ).build();
