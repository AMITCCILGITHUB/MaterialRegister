...
public class TestGroup extends Region {
	...
	private void initcomponents(String ctNumber) {
		...
		testList = (ArrayList<ValidationMaster>) ValidationData
				.getValidationDetails("Test");
		...
		while (testIterator.hasNext()) {
			if (i < 3) {
				...
				LTSCheckBox testDetail = new LTSCheckBox(
						vm.getValidationName(), vm.validationValueProperty(),
						true);
