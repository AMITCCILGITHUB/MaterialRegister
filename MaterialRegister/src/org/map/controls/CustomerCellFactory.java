...
public class CustomerCellFactory
		implements
		Callback<TableColumn<MaterialMaster, CustomerMaster>, TableCell<MaterialMaster, CustomerMaster>> {

	@Override
	public TableCell<MaterialMaster, CustomerMaster> call(
			TableColumn<MaterialMaster, CustomerMaster> param) {
	...
	public static class CustomerComboBoxCell extends
			TableCell<MaterialMaster, CustomerMaster> {
