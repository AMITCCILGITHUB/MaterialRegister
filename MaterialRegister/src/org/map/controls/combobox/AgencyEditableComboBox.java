...
public class AgencyEditableComboBox extends Region {
	...
	public AgencyEditableComboBox() {

		agencyProperty = new AgencyProperty();
		initComponent();
	}

	public AgencyEditableComboBox(String promptText) {
	...
	public AgencyEditableComboBox(String promptText, AgencyProperty agency) {
