...
public class LaboratoryEditableComboBox extends Region {
	...
	public LaboratoryEditableComboBox() {

		laboratoryProperty = new LaboratoryProperty();
		initComponent();
	}

	public LaboratoryEditableComboBox(String promptText) {
	...
	public LaboratoryEditableComboBox(String promptText, LaboratoryProperty laboratory) {
