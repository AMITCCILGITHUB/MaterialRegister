...
public class SpecificationComboBox extends Region {
	...
	public SpecificationComboBox(String promptText) {
	...
	public SpecificationComboBox(String promptText, SpecificationProperty specification) {
