...
public class TestEditableComboBox extends Region {
	...
	public TestEditableComboBox(String promptText) {
	...
	public TestEditableComboBox(String promptText, TestProperty test) {
