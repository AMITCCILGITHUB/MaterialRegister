...
public class EditTestGroup extends Region {
    ...
    public EditTestGroup(String ctNumber, Iterator<MaterialTestMap> testList) {
    ...
    private void initcomponents(String ctNumber, Iterator<MaterialTestMap> testIterator) {
        ...
        while (testIterator.hasNext()) {
            if (i < 3) {
                ...
                LETSCheckBox testDetail = new LETSCheckBox(test.getTestName(), test.getTestValue(), test.TestValueProperty(), true);
        ...
        addTest.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                newVm.getId().setValidationCode(ValidationData.getNextValidationNumber("Test") + newTests.size());
