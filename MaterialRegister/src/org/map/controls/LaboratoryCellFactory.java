...
public class LaboratoryCellFactory
		implements
		Callback<TableColumn<MaterialMaster, LaboratoryMaster>, TableCell<MaterialMaster, LaboratoryMaster>> {

	@Override
	public TableCell<MaterialMaster, LaboratoryMaster> call(
			TableColumn<MaterialMaster, LaboratoryMaster> param) {
	...
	public static class LaboratoryComboBoxCell extends
			TableCell<MaterialMaster, LaboratoryMaster> {
