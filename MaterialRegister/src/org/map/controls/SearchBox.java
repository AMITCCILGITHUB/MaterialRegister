        ...
        textBox.textProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                ...
                if (textBox.getText().length() == 0) {
                    ...
                    ArrayList results = (ArrayList) MaterialData.searchMaterialDetails(textBox.getText().trim());
    ...
    private void populateMenu(Iterator<String> results) {
        ...
        while (results.hasNext()) {
            ...
            menuItem.setOnAction(new EventHandler<ActionEvent>() {
                ...
                @Override
                public void handle(ActionEvent actionEvent) {
                    MaterialRegister.getMaterialRegister().goToPage("TreeItem [ value: View Material ]", result);
                }
            });
        }
    }
