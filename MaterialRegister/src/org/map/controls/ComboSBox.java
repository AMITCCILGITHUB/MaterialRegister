...
public class ComboSBox extends Region {
    ...
    public ComboSBox( String textValue, String promptText, StringProperty propertyValue, boolean bidirectional ) {
        initComponent( promptText );
        textBox.setText( textValue );
        if ( bidirectional ) {
            ...
            public void changed( ObservableValue<? extends String> observable, String oldValue, String newValue ) {
                if ( textBox.isFocused() == true ) {
                    if ( textBox.getText().length() == 0 ) {
                        ...
                        List<String> resultList = ValidationData.getValidationTypes();
