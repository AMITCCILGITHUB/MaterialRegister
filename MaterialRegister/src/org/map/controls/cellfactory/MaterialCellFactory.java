...
public class MaterialCellFactory
		implements
	...
	public MaterialCellFactory(ObservableList<HeatChartSheets> data) {
	...
	public TableCell<HeatChartSheets, String> call(
		...
		TextBoxCell textFieldCell = new TextBoxCell();
		return textFieldCell;
	}

	public class TextBoxCell extends TableCell<HeatChartSheets, String> {
