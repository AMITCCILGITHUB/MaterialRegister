...
import org.map.controls.combobox.LaboratoryEditableComboBox;
...
public class LaboratoryEditableCellFactory
		implements
	...
	public TableCell<MaterialTests, LaboratoryMaster> call(
		...
		LaboratoryEditableComboBoxCell textFieldCell = new LaboratoryEditableComboBoxCell();

		return textFieldCell;
	}

	public static class LaboratoryEditableComboBoxCell extends
			TableCell<MaterialTests, LaboratoryMaster> {

		private LaboratoryEditableComboBox laboratoryComboBox;
		private LaboratoryProperty boundToCurrently = null;

		public LaboratoryEditableComboBoxCell() {

			String strCss = "-fx-padding: 0;";

			setStyle(strCss);

			laboratoryComboBox = new LaboratoryEditableComboBox("Laboratory");
			...
			laboratoryComboBox.focusedProperty().addListener(
					new ChangeListener<Boolean>() {
						...
						public void changed(
							...
							LaboratoryEditableComboBox tf = (LaboratoryEditableComboBox) getGraphic();
