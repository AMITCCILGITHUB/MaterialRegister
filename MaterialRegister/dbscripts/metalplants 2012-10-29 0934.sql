...
CREATE TABLE `codemaster` (
  ...
  `Code_Datatype` varchar(64) DEFAULT NULL,
  `Code_Desc` varchar(64) DEFAULT NULL,
  `Code_Status` varchar(8) NOT NULL DEFAULT 'TRUE',
  `Created_By` varchar(32) NOT NULL DEFAULT 'SYSTEM',
  `Created_Date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`Code_Number`,`Code_Name`)
...
INSERT INTO `codemaster` VALUES ('Default_Year',1001,'2012','Integer','Default entry year for data','TRUE','SYSTEM','2012-10-22 06:47:41');
...
CREATE TABLE `materialmaster` (
  `Ct_Number` varchar(64) NOT NULL DEFAULT '',
...
INSERT INTO `usermaster` VALUES ('Admin','1','Admin','TRUE'),('Manju','3','Admin','TRUE');
...
-- Dump completed on 2012-10-29  9:35:20
