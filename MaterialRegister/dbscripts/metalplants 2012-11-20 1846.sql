...
CREATE TABLE `heatchartsheets` (
  `HeahChartSheet_Code` int(11) NOT NULL DEFAULT '1000',
  `Chart_Number` varchar(64) DEFAULT NULL,
  `Material_Code` int(11) DEFAULT NULL,
  ...
  `Created_By` varchar(32) NOT NULL DEFAULT 'SYSTEM',
  `Created_Date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`HeahChartSheet_Code`),
  UNIQUE KEY `HeahChartSheet_Code_UNIQUE` (`HeahChartSheet_Code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-11-20 18:46:34
