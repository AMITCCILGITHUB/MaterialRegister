...
CREATE TABLE `agencymaster` (
  `Agency_Code` int(11) NOT NULL DEFAULT '1000',
...
CREATE TABLE `codemaster` (
  `Code_Number` int(11) NOT NULL DEFAULT '1000',
  ...
  UNIQUE KEY `Code_Number_UNIQUE` (`Code_Number`)
...
CREATE TABLE `customermaster` (
  `Customer_Code` int(11) NOT NULL DEFAULT '1000',
...
CREATE TABLE `heatchartmaster` (
  `HeatChart_Code` int(11) NOT NULL DEFAULT '1000',
  `Chart_Number` varchar(64) DEFAULT NULL,
  ...
  UNIQUE KEY `HeatChart_Code_UNIQUE` (`HeatChart_Code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `heatchartmaster` VALUES (1001,'HC12/1','Equipment','Customer','PO Details','Drawing','Surveyor','Tag','TRUE','SYSTEM','2012-11-20 14:32:00');
...
CREATE TABLE `heatchartsheets` (
  `HeatChartSheet_Code` int(11) NOT NULL DEFAULT '1000',
  ...
  UNIQUE KEY `HeahChartSheet_Code_UNIQUE` (`HeatChartSheet_Code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `heatchartsheets` VALUES (1001,1001,1001,1001,1,1,'Part','Part Name','Size','Grade','TRUE','SYSTEM','2012-11-23 05:53:17'),(1002,1001,1002,1001,1,2,'Part','Part Name','Size','Grade','TRUE','SYSTEM','2012-11-23 05:53:17');
...
CREATE TABLE `itemmaster` (
  `Item_Code` int(11) NOT NULL DEFAULT '1000',
...
CREATE TABLE `laboratorymaster` (
  `Laboratory_Code` int(11) NOT NULL DEFAULT '1000',
...
CREATE TABLE `materialmaster` (
  `Material_Code` int(11) NOT NULL DEFAULT '1000',
...
INSERT INTO `materialmaster` VALUES (1001,'MP12/1',1001,1013,1003,'24',24,'heat','plate','TRUE','SYSTEM','2012-11-05 14:31:13'),(1002,'MP12/2',1001,1005,1001,'45',1,'','','TRUE','SYSTEM','2012-11-24 18:42:14'),(1003,'MP12/3',1004,1011,1008,'4',9,'Heat','Plate','TRUE','SYSTEM','2012-11-24 19:14:55');
...
CREATE TABLE `materialtests` (
  `Test_Code` int(11) NOT NULL DEFAULT '1000',
...
INSERT INTO `materialtests` VALUES (1001,'B',1005,1009,'-',1001,'05-11-12','R1',1002,'-','-','-',1001,'TRUE','SYSTEM','2012-11-05 14:31:35'),(1002,'A',1001,1002,'-',1002,'01-11-12','R2',1001,'-','-','-',1001,'TRUE','SYSTEM','2012-11-05 14:31:14'),(1003,'A',1001,1009,'Equipment',1001,'01-02-12','R2',1001,'','','',1002,'TRUE','SYSTEM','2012-11-24 18:42:14'),(1004,'C',1005,1009,'-',1001,'05-11-12','R1',1002,'-','-','-',1001,'TRUE','SYSTEM','2012-11-05 14:31:35'),(1005,'A',1005,1010,'1',1001,'01-11-12','R1',1001,'','','',1003,'TRUE','SYSTEM','2012-11-24 19:14:55'),(1006,'B',1010,1013,'2',1002,'14-11-12','R2',1002,'','','Reason',1003,'TRUE','SYSTEM','2012-11-24 19:15:00');
...
CREATE TABLE `resultmaster` (
  `Result_Code` int(11) NOT NULL DEFAULT '1000',
...
CREATE TABLE `rolemaster` (
  `Role_Code` int(11) NOT NULL DEFAULT '1000',
...
INSERT INTO `rolemaster` VALUES (1001,'Admin','Administrator','TRUE','SYSTEM','2012-10-27 16:35:05'),(1002,'User','Allowed to insert details','TRUE','SYSTEM','2012-10-27 16:35:05'),(1003,'Viewer','Alowed to view details','TRUE','SYSTEM','2012-10-27 16:35:05');
...
CREATE TABLE `specificationmaster` (
  `Specification_Code` int(11) NOT NULL DEFAULT '1000',
...
CREATE TABLE `usermaster` (
  ...
  `User_Status` varchar(8) DEFAULT 'TRUE',
...
INSERT INTO `usermaster` VALUES (1001,'Admin','1',1001,'TRUE'),(1002,'Amit','2',1002,'TRUE');
...
-- Dump completed on 2012-11-25  1:39:19
